...
namespace JurasicPark
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (keepGoing)
            {
                Console.WriteLine("Do you want to View, Summarize, Add, Remove, Transfer, Description, or Quit? ");
                ...
                else if (choice == "summarize")
                {
                    ...
                    Console.WriteLine($"There are {foundCarn} carnivores and {foundHerb} herbivores in the park.");
                }
                ...
                //description - this gives all the info on all the dinos 
